...
This folder defines all source code for the 'Global Mart' pipeline:
...
* Take a look at the sample under "sample_users_global_mart.py" to get familiar with the syntax.
