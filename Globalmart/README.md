...
This folder defines all source code for the 'Globalmart' pipeline:
...
* Take a look at the sample under "sample_users_globalmart.py" to get familiar with the syntax.
